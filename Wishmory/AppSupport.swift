...
enum AwwHaptics {
    ...
    /// Makes pull-to-refresh feel like a deliberate, physical gesture rather
    /// than a passive loading state.
    ...
    /// A longer, celebratory finish lets the user feel that fresh content has
    /// landed, without adding feedback during the loading interval itself.
