...
struct Home: View {
    ...
    @State private var homeCommunityRefreshToken = 0
    ...
    private var content: some View {
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            peopleGrid
                ...
                .padding(.top, isComposerFocused ? 22 : 0)

            if !isComposerFocused {

                // Invite / Spark / Product tip

                // This view controls its own top spacing.

                HomeEventCommunitySection(
                    refreshTrigger: homeCommunityRefreshToken,
    ...
    private func refreshHome() async {
        ...
        // Manual pull-to-refresh always gives the rotating tip area
        // a chance to show a card, regardless of the normal cooldown.
        homeCommunityRefreshToken &+= 1
